...
function construirConsultaOnda() {
	...
	urlOnda = peticionOnda + estacion + "loc=*&" + canal + fechainionda + fechafinonda + 'nodata=404';
	var mostrar=peticionOnda + estacion1 + "loc=*&" + canal + fechainionda + fechafinonda + 'nodata=404';
